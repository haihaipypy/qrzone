...
import { getAgnesApiKey, setAgnesApiKey } from "@/lib/agnes";
...
export function QrcodeGenerator<P extends {}>(props: QrcodeGeneratorProps<P>) {
  ...
  useEffect(() => {
    setApiKeyState(getAgnesApiKey());
  }, []);
  const updateApiKey = (value: string) => {
    setApiKeyState(value);
    setAgnesApiKey(value);
  };
                ...
                <>
                  ...
                  <Button
                    ...
                    onClick={() => {
                      ...
                      if (!apiKey.trim()) {
                        toast.error("请先填写 Agnes API Key");
                        return;
                      }
